...
import sortCSVdata
import time
from TransformerModel import TransformerModel  # Import the TransformerModel class correctly
...
def preprocess_data(df):
    # Modify the preprocessing to suit Transformer's input format
...
def train_model(X_train, y_train, namemodel):
    # Modify the model architecture and training process to use the TransformerModel
    ...
    model = TransformerModel(input_dim, num_heads, ff_dim, num_transformer_blocks, mlp_units)
...
if __name__ == "__main__":
    ...
    namemodel = "eurusd_transformer_model.h5"
